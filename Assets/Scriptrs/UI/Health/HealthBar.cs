...
public class HealthBar : MonoBehaviour
{
    ...
    private void OnHealthChanged(int value)
    {
        ...
        {
            int createHealthAmount = value - _hearts.Count;
            for (int i = 0; i < createHealthAmount; i++)
            {
                CreateHeart();
            }
        }
        ...
        {
            int deleteHealthAmount = _hearts.Count - value;
            for (int i = 0; i < deleteHealthAmount; i++)
            {
